...
ActiveRecord::Schema.define(version: 2019_05_17_010734) do
  ...
  create_table "custom_products", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "stuffed_animal_id"
    t.decimal "stuffed_animal_price", default: "0.0"
    t.index ["order_id"], name: "index_custom_products_on_order_id"
    t.index ["stuffed_animal_id"], name: "index_custom_products_on_stuffed_animal_id"
  end
  ...
  create_table "product_accessories", force: :cascade do |t|
    ...
    t.index ["custom_product_id"], name: "index_product_accessories_on_custom_product_id"
  end
